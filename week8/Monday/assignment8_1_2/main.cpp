/*
In our animal exercise, we couldn't create a vector of our animal objects.  Now, with smart pointers we have tools to make this happen.
...
int main()
{
    std::vector<std::unique_ptr<animal>> data = read_file("./data/test.txt");
